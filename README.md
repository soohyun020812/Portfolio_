...
### 📌 기능
>**마이페이지** <br>
>_로그인, 로그아웃, 회원가입, 회원탈퇴를 제공_ <br>
>_프로필에서 사용자는 자신의 정보를 수정 가능_ <br>
>_비밀번호 찾기 기능은 Email을 입력해 재설정 링크 발송_

>**커뮤니티** <br>
>_게시글 생성, 수정, 삭제, 조회 가능_ <br>
>_게시글의 댓글, 대댓글, 좋아요 기능_ <br>
>_사용자 필요에 따라 첨부파일 추가_

>**운동 정보** <br>
>_운동에 대한 정보 (운동명, 난이도, 운동부위 등..) 조회_ <br>
>_해당 정보는 관리자만 수정 가능_

>**건강 정보** <br>
>_사용자의 최근 건강 정보를 입력 및 조회 가능_ <br>
>_사용자는 맞춤으로 운동 루틴이 생성 및 공유 가능_ <br>
>_사용자가 최근 30일 본인의 식단을 기록 및 조회_
...
### 💥 트러블슈팅
>**Django 테스트**
>_모델 내용을 변경하지 않고, 그 모델을 참조하는 다른 모델 조회 시 불일치_
>__모델을 변경시킬 때 마다 save()를 통해 변경하여 해결__
